...
class Hover3DV13(_Hover, _ThreeD):

    def __init__(self, obs_size=12):
        _Hover.__init__(self, obs_size, 4, max_steps=20000, out_of_bounds_penalty=0, initial_altitude=5)
...
class HoverVisual(Hover3DV13):
    RES = 16

    def __init__(self, vs=VisionSensor(res=RES)):
        Hover3DV13.__init__(self)
    ...
    def step(self, action):
        result = Hover3DV13.step(self, action)
