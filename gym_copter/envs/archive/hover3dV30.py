...
class Hover3DV30(_Hover, _ThreeD):

    def __init__(self, obs_size=12, position_sigma=0.5, attitude_sigma=(np.pi/5)):
        _Hover.__init__(self, obs_size, 4, max_steps=20000, out_of_bounds_penalty=10000, initial_altitude=8,
...
class HoverVisual(Hover3DV30):
    RES = 16

    def __init__(self, vs=VisionSensor(res=RES)):
        Hover3DV30.__init__(self)
    ...
    def step(self, action):
        result = Hover3DV30.step(self, action)
