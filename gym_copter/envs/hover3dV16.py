...
class Hover3DV16(_Hover, _ThreeD):

    def __init__(self, obs_size=12):
        _Hover.__init__(self, obs_size, 4, max_steps=20000, out_of_bounds_penalty=100, initial_altitude=3, initial_random_position=False)
...
class HoverVisual(Hover3DV16):
    RES = 16

    def __init__(self, vs=VisionSensor(res=RES)):
        Hover3DV16.__init__(self)
    ...
    def step(self, action):
        result = Hover3DV16.step(self, action)
