...
class ModelB_V1(_Hover, _ThreeD):
    def __init__(self, obs_size=12,
                 fault_magnitude=None, weights=None, enable_passive_faults=False,
...
class HoverVisual(ModelB_V1):
    RES = 16

    def __init__(self, vs=VisionSensor(res=RES)):
        ModelB_V1.__init__(self)
    ...
    def step(self, action):
        result = ModelB_V1.step(self, action)
